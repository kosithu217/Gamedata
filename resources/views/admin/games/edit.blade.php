                        ...
                        <form method="POST" action="{{ route('admin.games.update', $game) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('game_type') is-invalid @enderror" 
                                        ...
                                        <option value="swf" {{ old('game_type', $game->game_type ?? 'swf') == 'swf' ? 'selected' : '' }}>
                                            {{ __('SWF Game (Upload File)') }}
                                        </option>
                                        <option value="iframe" {{ old('game_type', $game->game_type) == 'iframe' ? 'selected' : '' }}>
                            ...
                            <div id="iframe-fields">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control @error('iframe_url') is-invalid @enderror" 
                                               id="iframe_url" name="iframe_url" value="{{ old('iframe_url', $game->iframe_url) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('iframe_code') is-invalid @enderror" 
                                                  ...
                                                  placeholder="<iframe src='https://example.com/game.html' width='800' height='600'></iframe>">{{ old('iframe_code', $game->iframe_code) }}</textarea>
                                ...
                                @if($game->isIframeGame())
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('Current Game Preview') }}</label>
                                        <div class="card">
                                            <div class="card-body">
                                                @if($game->iframe_code)
                                                    <p><strong>{{ __('Custom Iframe Code') }}:</strong></p>
                                                    <pre class="bg-light p-2 rounded"><code>{{ $game->iframe_code }}</code></pre>
                                                @elseif($game->iframe_url)
                                                    <p><strong>{{ __('Iframe URL') }}:</strong> <a href="{{ $game->iframe_url }}" target="_blank">{{ $game->iframe_url }}</a></p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
